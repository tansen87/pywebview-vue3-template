...
import sys
import os
src_py_dir = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
...
rootDir = os.path.dirname(src_py_dir)
buildDir = os.path.join(rootDir, 'build')
logoPath = os.path.join(rootDir, 'src_py', 'icon', 'logo.ico')
